...
const translations = {
    ja: {
        ...
        "feature.investigate.tag": "調べる",
        "feature.investigate.desc": "広告だらけのウェブで、本当に知りたいことが見つからないストレスはもうありません。クイックガイド機能なら、知りたいことだけをピンポイントで抽出。AIエージェントがウェブやX（旧Twitter）を縦横無尽にリサーチし、あなたのためだけに最適な情報を届けます。",
        "feature.play.tag": "あそぶ",
        "feature.play.desc": "AIが自動生成する国当てゲームやクイズで、旅の知識を楽しくアップデート。AIガイドとの自然な会話を楽しみながら、あなただけのルートを作成しましょう。まるで本物のツアーに参加しているような臨場感あふれる音声ガイドで、移動時間さえも最高のエンターテインメントに変わります。",
        "feature.learn.tag": "学ぶ",
        "feature.learn.desc": "AIエージェントがウェブとXを常にリサーチし、最新かつ正確な一次情報を取得。世界中の世界遺産データが網羅されており、知的好奇心を深く満たします。お気に入りのガイドやクイズはライブラリに保存寿。いつでも何度でも、新しい学びへとチャレンジできます。",
        "feature.create.tag": "創る",
        "feature.create.desc": "旅の思い出を、AIが美しいデジタルガイドブックとして自動生成します。気分に合わせたデザインテーマを選べるほか、共有機能による共同編集も可能。作成した一冊は、美しいライブラリーに保管され、後からいつでも当時の感動を鮮やかに見返すことができます。",
        "support.tag": "Support",
        "support.title": "アプリの使い方・サポート",
        "support.description": "AIにチャットでいつでも相談できる、新しいサポート体験",
        "support.chat.title": "AIチャットサポート",
        "support.chat.desc": "「このボタンは何？」「おすすめの使い方は？」など、アプリの操作や機能についてAIがリアルタイムでお答えします。24時間いつでも、あなたの疑問を解消します。",
        "support.guide.title": "インタラクティブ・マニュアル",
        "support.guide.desc": "分厚い説明書を読む必要はありません。やりたいことを伝えるだけで、AIが最適な操作ステップを案内します。初めての方でも、すぐに使いこなせるようになります。",
        "support.trouble.title": "トラブルシューティング",
        "support.trouble.desc": "不具合や困ったことがあっても安心。AIが状況をヒアリングし、解決策を提示します。必要に応じて詳細なサポートページへもスムーズに誘導します。",
        ...
        "concept.lead": "地図をもっと楽しく、もっと自由に。<br>「どこでもバスガイド」が広げる4つの世界",
    ...
    en: {
        ...
        "nav.guides": "Guides",
        "hero.description": "Tour World Heritage sites, learn with quizzes, and talk with AI.<br>Transform your travel into a time of the most luxurious intellectual curiosity.",
        "hero.button.download": "Free Download",
        "hero.button.worldguide": "Experience the Guide",
        "nav.screenshots": "Screenshots",
        "nav.download": "Download",
        "hero.title.impact": "Maps as the Ultimate Entertainment!",
        "feature.investigate.tag": "Investigate",
        "feature.investigate.desc": "No more stress of not finding what you really want to know on an ad-filled web. The Quick Guide feature extracts only what you want to know. AI agents research the web and X (formerly Twitter) to deliver the best information just for you.",
        "feature.play.tag": "Play",
        "feature.play.desc": "Update your travel knowledge enjoyably with country guessing games and quizzes automatically generated by AI. Create your own route while enjoying natural conversation with AI guides. With immersive voice guides that feel like participating in a real tour, even travel time turns into the best entertainment.",
        "feature.learn.tag": "Learn",
        "feature.learn.desc": "AI agents always research the web and X to acquire the latest and accurate primary information. Comprehensive data on World Heritage sites around the world satisfies your intellectual curiosity. Save your favorite guides and quizzes in the library. Challenge yourself to new learning anytime, as many times as you like.",
        "feature.create.tag": "Create",
        "feature.create.desc": "AI automatically generates your travel memories as a beautiful digital guidebook. Choose design themes to suit your mood, and collaborate via sharing functions. Your created book is stored in a beautiful library, allowing you to vividly look back on the emotions of the time anytime.",
        "support.tag": "Support",
        "support.title": "App Usage & Support",
        "support.description": "A new support experience where you can consult AI via chat anytime",
        "support.chat.title": "AI Chat Support",
        "support.chat.desc": "\"What is this button?\" \"What's the recommended way to use it?\" AI answers in real-time about app operations and features. Solve your questions 24 hours a day.",
        "support.guide.title": "Interactive Manual",
        "support.guide.desc": "No need to read thick manuals. Just tell the AI what you want to do, and it will guide you through the optimal operation steps. Even first-time users can master it immediately.",
        "support.trouble.title": "Troubleshooting",
        "support.trouble.desc": "Peace of mind even if there's a problem. AI hears the situation and suggests solutions. Smoothly guide to detailed support pages as needed.",
        ...
        "concept.lead": "Explore the maps more fun and more freely.<br>The 4 worlds expanded by \"DocoDemo Guide\"",
